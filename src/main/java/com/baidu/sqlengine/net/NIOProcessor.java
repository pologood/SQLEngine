...
public final class NIOProcessor {
    ...
    public final static ConcurrentLinkedQueue<BackendConnection> backends_old =
    ...
    private void backendCheck() {
        long sqlTimeout = SqlEngineServer.getInstance().getConfig().getSystem().getSqlExecuteTimeout() * 1000L;
