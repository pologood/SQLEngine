...
import com.baidu.sqlengine.memory.unsafe.utils.sort.UnsafeKVExternalSorter;
...
public final class UnsafeFixedWidthAggregationMap {
    ...
    public UnsafeKVExternalSorter destructAndCreateExternalSorter() throws IOException {
        return new UnsafeKVExternalSorter(
                ...
                SqlEngineServer.getInstance().getSqlEngineMemory().getBlockManager(),
                SqlEngineServer.getInstance().getSqlEngineMemory().getSerializerManager(),
