package com.baidu.sqlengine.memory.unsafe.utils;

import java.util.concurrent.ConcurrentHashMap;

public class SqlEnginePropertyConf {

    private ConcurrentHashMap settings = new ConcurrentHashMap<String, String>();

    public SqlEnginePropertyConf() {
     ...
     */
    public SqlEnginePropertyConf set(String key, String value) {
        set(key, value, false);
        return this;
    }

    public SqlEnginePropertyConf set(String key, String value, boolean silent) {
