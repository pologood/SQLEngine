...
public final class UnsafeExternalSorter extends MemoryConsumer {
  ...
  private UnsafeExternalSorter(
    ...
    if(SqlEngineServer.getInstance().getSqlEngineMemory() != null){
         this.fileBufferSizeBytes = (int) SqlEngineServer.getInstance().
                 getSqlEngineMemory().getConf().getSizeAsBytes("sqlEngine.merge.file.buffer", "32k");
    }else{
