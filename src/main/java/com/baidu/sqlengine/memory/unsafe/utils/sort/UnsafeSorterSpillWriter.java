...
import com.baidu.sqlengine.memory.unsafe.storage.ConnectionId;
import com.baidu.sqlengine.memory.unsafe.storage.DataNodeDiskManager;
import com.baidu.sqlengine.memory.unsafe.storage.DataNodeFileManager;
import com.baidu.sqlengine.memory.unsafe.storage.DiskRowWriter;
import com.baidu.sqlengine.memory.unsafe.storage.DummySerializerInstance;
...
public final class UnsafeSorterSpillWriter {
    ...
    public UnsafeSorterSpillWriter(
        ...
        writer = blockManager
                .getDiskWriter(conId, file, DummySerializerInstance.INSTANCE, fileBufferSize/**,writeMetrics*/);
