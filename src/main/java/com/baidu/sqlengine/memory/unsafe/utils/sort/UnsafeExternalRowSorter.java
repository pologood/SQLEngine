...
import com.baidu.sqlengine.merge.RowDataPacketSorter;
...
public final class UnsafeExternalRowSorter {
    ...
    public UnsafeExternalRowSorter(DataNodeMemoryManager dataNodeMemoryManager,
                                   @Nonnull SqlEngineMemory sqlEngineMemory,
                                   StructType schema,
        ...
        sorter = UnsafeExternalSorter.create(
                ...
                sqlEngineMemory.getBlockManager(),
                sqlEngineMemory.getSerializerManager(),
                recordComparator,
                prefixComparator,
                sqlEngineMemory.getConf().getSizeAsBytes("sqlEngine.pointer.array.len", "16K"),
                pageSizeBytes,
                canUseRadixSort,
                enableSort);
    }
            ...
            return new AbstractScalaRowIterator<UnsafeRow>() {
                ...
                public UnsafeRow next() {
                    try {
                        ...
                        row.pointTo(sortedIterator.getBaseObject(), sortedIterator.getBaseOffset(),
