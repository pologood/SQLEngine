...
public class RedisPreparedStatement extends RedisStatement implements PreparedStatement {
    ...
    private final RedisSQLParser redissql;
    private List params = new ArrayList();

    public RedisPreparedStatement(RedisConnection conn, int type, int concurrency, int holdability, String sql)
            throws RedisSQLException {
        super(conn, type, concurrency, holdability);
        this.sql = sql;
        this.redissql = new RedisSQLParser(conn.getDB(), sql);
    }
    ...
    public int executeUpdate() throws SQLException {
        this.redissql.setParams(this.params);
        return this.redissql.executeUpdate();
    }

    public void setValue(int idx, Object o) {
        while (this.params.size() <= idx) {
            this.params.add(null);
        }
        this.params.set(idx, o);
    }
