...
public class MongoPreparedStatement extends MongoStatement implements PreparedStatement {
    ...
    private final MongoSQLParser mongosql;
    private List params = new ArrayList();

    public MongoPreparedStatement(MongoConnection conn, int type, int concurrency, int holdability, String sql)
            throws MongoSQLException {
        super(conn, type, concurrency, holdability);
        this.sql = sql;
        this.mongosql = new MongoSQLParser(conn.getDB(), sql);
    }
    ...
    public int executeUpdate() throws SQLException {
        this.mongosql.setParams(this.params);
        return this.mongosql.executeUpdate();
    }
