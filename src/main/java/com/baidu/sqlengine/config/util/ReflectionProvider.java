...
public class ReflectionProvider {
    ...
    public void visitSerializableFields(Object object, FieldVisitor visitor) {
        for (Iterator<Field> iterator = fieldDictionary.serializableFieldsFor(object.getClass());
             iterator.hasNext(); ) {
