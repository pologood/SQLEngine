...
public class ClusterConfig {
    private final Map<String, SqlEngineNodeConfig> nodes;
    ...
    public Map<String, SqlEngineNodeConfig> getNodes() {
        return nodes;
    }
    ...
    private static Map<String, SqlEngineNodeConfig> loadNode(Element root, int port) {
        Map<String, SqlEngineNodeConfig> nodes = new HashMap<String, SqlEngineNodeConfig>();
        ...
        for (int i = 0, n = list.getLength(); i < n; i++) {
            ...
            if (node instanceof Element) {
                ...
                SqlEngineNodeConfig conf = new SqlEngineNodeConfig(name, host, port, weight);
                nodes.put(name, conf);
                hostSet.add(host);
            }
        }
    ...
    private static Map<String, List<String>> loadGroup(Element root, Map<String, SqlEngineNodeConfig> nodes) {
