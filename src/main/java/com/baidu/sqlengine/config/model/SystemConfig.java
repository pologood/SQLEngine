...
public final class SystemConfig {
	...
	public static final String SYS_HOME = "SQL_ENGINE_HOME";
	...
	/*
	 * 注意！！！ 目前sqlEngine支持的MySQL版本，如果后续有新的MySQL版本,请添加到此数组， 对于MySQL的其他分支，
	...
	private String sqlInterceptor = "com.baidu.sqlengine.server.interceptor.impl.DefaultSqlInterceptor";
	...
	/**
	 * SqlEngine 使用 Off Heap For Merge/Order/Group/Limit计算相关参数
	 */
	...
	public static String getHomePath() {
		...
		// SQL_ENGINE_HOME为空，默认尝试设置为当前目录或上级目录。BEN
		if(home == null) {
			try {
	...
	public int getSqlEngineNodeId() {
		return sqlEngineNodeId;
	}

	public void setSqlEngineNodeId(int sqlEngineNodeId) {
		this.sqlEngineNodeId = sqlEngineNodeId;
	}
	...
	public String toString() {
		return "SystemConfig [processorBufferLocalPercent="
				...
				+ ", sqlEngineNodeId=" + sqlEngineNodeId + "]";
	}
