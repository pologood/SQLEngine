...
public class UserStat {
    ...
    public UserStat(String user) {
        super();
        int size = SqlEngineServer.getInstance().getConfig().getSystem().getSqlRecordCount();
    ...
    public void update(int sqlType, String sql, long sqlRows,
        ...
        //记录超过阈值的大结果集sql
        if (rseultSetSize >= SqlEngineServer.getInstance().getConfig().getSystem().getMaxResultSet()) {
